...
post_rec_SVD <- Recommender(m, method = "SVD")

# PreTrained
pre_rec_UBCF <- Recommender(m[155:5560], method = "UBCF")
pre_rec_SVD <- Recommender(m[155:5560], method = "SVD")
...
for (i in 1:length(data_article_UBCF$ResponseId)){
  ...
  tmp_post_pred_A1 = post_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A1) %>% as.numeric()
  tmp_post_pred_A2 = post_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A2) %>% as.numeric()
  tmp_post_pred_A3 = post_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A3) %>% as.numeric()
  tmp_post_pred_A4 = post_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A4) %>% as.numeric()
  tmp_pre_pred_A1 = pre_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A1) %>% as.numeric()
  tmp_pre_pred_A2 = pre_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A2) %>% as.numeric()
  tmp_pre_pred_A3 = pre_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A3) %>% as.numeric()
  tmp_pre_pred_A4 = pre_pred_UBCF_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_A4) %>% as.numeric()
...
dist_post_UBCFRating_predictions <- mrg_post_UBCFRating_predictions %>% 
  group_by(ResponseId) %>% 
  mutate(Abstand = abs(RS_Post_Prediction - User_Bewertung)) %>% 
...
dist_pre_UBCFRating_predictions <- mrg_pre_UBCFRating_predictions %>% 
  group_by(ResponseId) %>% 
  mutate(Abstand = abs(RS_Pre_Prediction - User_Bewertung)) %>% 
...
for (i in 1:length(data_article_SVD$ResponseId)){
  ...
  user_ID <- paste("\"",user$ResponseId,"\"", sep = "")
  tmp_post_pred_B1 = post_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B1) %>% as.numeric()
  tmp_post_pred_B2 = post_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B2) %>% as.numeric()
  tmp_post_pred_B3 = post_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B3) %>% as.numeric()
  tmp_post_pred_B4 = post_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B4) %>% as.numeric()
  tmp_pre_pred_B1 = pre_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B1) %>% as.numeric()
  tmp_pre_pred_B2 = pre_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B2) %>% as.numeric()
  tmp_pre_pred_B3 = pre_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B3) %>% as.numeric()
  tmp_pre_pred_B4 = pre_pred_SVD_matrix %>% filter(ResponseId == user_ID) %>% select(user$ID_B4) %>% as.numeric()
