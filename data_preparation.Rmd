...
data_cleaned$loop1.1_1<-recode(data_cleaned$loop1.1_1, `0` = 1)
data_cleaned$loop1.2_1<-recode(data_cleaned$loop1.2_1, `0` = 1)
data_cleaned$loop1.3_1<-recode(data_cleaned$loop1.3_1, `0` = 1)
data_cleaned$loop1.4_1<-recode(data_cleaned$loop1.4_1, `0` = 1)
data_cleaned$loop2.1_1<-recode(data_cleaned$loop2.1_1, `0` = 1)
data_cleaned$loop2.2_1<-recode(data_cleaned$loop2.2_1, `0` = 1)
data_cleaned$loop2.3_1<-recode(data_cleaned$loop2.3_1, `0` = 1)
data_cleaned$loop2.4_1<-recode(data_cleaned$loop2.4_1, `0` = 1)
```
