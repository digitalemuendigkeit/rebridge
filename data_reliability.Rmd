...
```
Die Reliabilität von den Gewissenhaftigkeit ($\alpha =$ `r result$alpha[2]`), Verträglichkeit ($\alpha =$ `r result$alpha[4]`) und Neurozität ($\alpha =$ `r result$alpha[5]`) ist jeweils kleiner als $\alpha = .6$. Einzig die Aussagen zur Extraversion ($\alpha =$ `r result$alpha[3]`) weist eine gute und Offenheit ($\alpha =$ `r result$alpha[1]`) eine noch akzeptable auswertbare Realibität auf. Daher wird auf eine Auswertung der Big Five im Folgenden verzichtet.
...
rel_anlernen <- data_cleaned %>% select(starts_with("Anlernen"),starts_with("firstReviewArticles"))

# Neucodieren der einzelnen Artikelbewertungen
rel_anlernen$Anlernen1_1<-recode(rel_anlernen$Anlernen1_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen2_1<-recode(rel_anlernen$Anlernen2_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen3_1<-recode(rel_anlernen$Anlernen3_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen4_1<-recode(rel_anlernen$Anlernen4_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen5_1<-recode(rel_anlernen$Anlernen5_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen6_1<-recode(rel_anlernen$Anlernen6_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_anlernen$Anlernen7_1<-recode(rel_anlernen$Anlernen7_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)

keys_bf  <- list(Anlernen_SUM_bew = c("Anlernen1_1","Anlernen2_1","Anlernen3_1","Anlernen4_1","Anlernen5_1","Anlernen6_1","Anlernen7_1"),
                 Anlernen_ArticleReview_quality = c("Anlernen_ArticleReview_quality1","Anlernen_ArticleReview_quality2","Anlernen_ArticleReview_quality3"))
...
data_anlernen <-  data_cleaned %>%  select(ResponseId, Anlernen_ArticleReview_diversity, Anlernen_ArticleReview_novelty, Anlernen_ArticleReview_serendipity, Anlernen_ArticleReview_relevance) %>%  inner_join(., data_anlernen, by="ResponseId")
```
...
-->
```{r UBCF_reliability}
rel_UBCF <- data_cleaned %>% select(starts_with("loop1"),starts_with("UBCF"))

# Neucodieren der einzelnen Artikelbewertungen
rel_UBCF$loop1.1_1<-recode(rel_UBCF$loop1.1_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_UBCF$loop1.2_1<-recode(rel_UBCF$loop1.2_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_UBCF$loop1.3_1<-recode(rel_UBCF$loop1.3_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_UBCF$loop1.4_1<-recode(rel_UBCF$loop1.4_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)

keys_bf  <- list(UBCF_SUM_Artikel = c("loop1.1_1","loop1.2_1","loop1.3_1","loop1.4_1"),
                 UBCF_ArticleReview_quality = c("UBCF_ArticleReview_quality1","UBCF_ArticleReview_quality2","UBCF_ArticleReview_quality3"),
...
data_UBCF <-  data_cleaned %>%  select(ResponseId, UBCF_ArticleReview_diversity, UBCF_ArticleReview_novelty, UBCF_ArticleReview_serendipity) %>%  inner_join(., data_UBCF, by="ResponseId")
```
...
-->
```{r SVD_reliability}
rel_SVD <- data_cleaned %>% select(starts_with("loop2"),starts_with("SVD"))

# Neucodieren der einzelnen Artikelbewertungen
rel_SVD$loop2.1_1<-recode(rel_SVD$loop2.1_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_SVD$loop2.2_1<-recode(rel_SVD$loop2.2_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_SVD$loop2.3_1<-recode(rel_SVD$loop2.3_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)
rel_SVD$loop2.4_1<-recode(rel_SVD$loop2.4_1, `0` = 1, `2` = 2.25, `3` = 3.5, `4` = 4.75, `5` = 6)

keys_bf  <- list(SVD_SUM_Artikel = c("loop2.1_1","loop2.2_1","loop2.3_1","loop2.4_1"),
                 SVD_ArticleReview_quality = c("SVD_ArticleReview_quality1","SVD_ArticleReview_quality2","SVD_ArticleReview_quality3"),
                 SVD_RS_bew = c("-SVD_Review_1","SVD_Review_2","-SVD_Review_3","SVD_Review_4","-SVD_Review_5"))
...
data_SVD <-  data_cleaned %>%  select(ResponseId, SVD_ArticleReview_diversity, SVD_ArticleReview_novelty, SVD_ArticleReview_serendipity, SVD_ArticleReview_relevance) %>%  inner_join(., data_SVD, by="ResponseId")
```
