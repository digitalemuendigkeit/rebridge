...
#rel_big %>% map(sjlabelled::get_label) %>% str_split("-") -> labels_bf 
...
keys_bf  <- list(Anlernen_SUM_bew = c("Anlernen_scale1_1","Anlernen_scale2_1","Anlernen_scale3_1","Anlernen_scale4_1","Anlernen_scale5_1","Anlernen_scale6_1","Anlernen_scale7_1"),
...
-->
```{r UBCF_reliability}
rel_UBCF <- data_cleaned %>% select(starts_with("loop1_scale"),starts_with("UBCF"))

keys_bf  <- list(UBCF_SUM_Artikel = c("loop1_scale.1_1","loop1_scale.2_1","loop1_scale.3_1","loop1_scale.4_1"),
...
-->
```{r SVD_reliability}
rel_SVD <- data_cleaned %>% select(starts_with("loop2_scale"),starts_with("SVD"))

keys_bf  <- list(SVD_SUM_Artikel = c("loop2_scale.1_1","loop2_scale.2_1","loop2_scale.3_1","loop2_scale.4_1"),
