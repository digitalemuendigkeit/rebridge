...
```{r data_publishing}
mrg_data_pub_gen <- data_publishing %>% select(-ResponseId)
mrg_data_pub_gen$RS_dataPublishing_1 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_1)
mrg_data_pub_gen$RS_dataPublishing_2 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_2)
mrg_data_pub_gen$RS_dataPublishing_3 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_3)
mrg_data_pub_gen$RS_dataPublishing_4 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_4)
mrg_data_pub_gen$RS_dataPublishing_5 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_5)
mrg_data_pub_gen$RS_dataPublishing_6 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_6)
mrg_data_pub_gen$RS_dataPublishing_7 <- as.numeric(mrg_data_pub_gen$RS_dataPublishing_7)
