...
#t.test(data_demograph$age ~ data_demograph$gender)
```
...
#sig# describe.ttest(t.test(data_newsConsum$newsPortalFrequency_2 ~ data_demograph$gender))
...
Die Befragten machen sich leichte Sorgen um ihre Privatsphäre beim Verwenden von Empfehlungssystemen (`r describe.mean.sd(data_priv$RS_Privacy_Consern)
`). Insgesamt machen sich die Frauen etwas mehr Sorgen um ihre Privatsphäre (`r describe.mean.sd(m= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, mean)[2], sd= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, sd)[2])`) als die männlichen Befragten (`r describe.mean.sd(m= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, mean)[1], sd= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, sd)[1])`). Dieser Unterschied ist aber nicht signifikant (`r describe.ttest(t.test(data_priv$RS_Privacy_Consern ~ data_demograph$gender))`).
