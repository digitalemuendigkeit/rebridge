...
#tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, mean)[1]
#tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, sd)[1]

#describe.mean.sd(m= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, mean)[1], sd= tapply(data_priv$RS_Privacy_Consern, data_demograph$gender, sd)[1])
```
